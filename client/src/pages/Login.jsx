...
import api from '../configs/api'; // Ensure this path matches your file structure
...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
 const path = state === "login" ? "login" : "register"; 

    try {
        const { data } = await api.post(`/api/user/${path}`, formData);
